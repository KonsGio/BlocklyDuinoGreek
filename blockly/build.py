...
if sys.version_info[0] != 2:
  raise Exception("To blockly είναι συμβατό με τις εκδόσεις Python 2.x.\n"
                  "Χρησιμοποιείται την έκδοση: " + sys.version)
...
HEADER = ("// Μην επεξεργάζεστε αυτο το αρχείο παράγεται αυτόματα.\n")
